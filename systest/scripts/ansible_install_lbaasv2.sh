...
DRIVER_LOC=git+https://github.com/pjbreaux/f5-openstack-lbaasv2-driver.git@newton_merge
...
sudo -E docker pull docker-registry.pdbld.f5net.com/openstack-test-ansibleserver-prod/newton
sudo -E docker run \
